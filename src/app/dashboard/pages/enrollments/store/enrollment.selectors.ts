...
export const selectEnrollmentState =createFeatureSelector<fromEnrollment.State>(fromEnrollment.enrollmentFeatureKey);
...
export const selectStudentOptions = createSelector(selectEnrollmentState,(state) => state.studentOptions);

export const selectIsLoadingDialogOptions = createSelector(selectEnrollmentState,(state) => state.isLoadingDialogOptions);